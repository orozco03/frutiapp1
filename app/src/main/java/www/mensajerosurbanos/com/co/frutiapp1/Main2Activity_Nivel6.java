...
public class Main2Activity_Nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, R.string.nivel6,Toast.LENGTH_SHORT).show();
    ...
    public void NumAleatorio(){
        if(score <= 70){
            ...
            if (numAleatorio_uno >=0 && numAleatorio_uno <= 3){
                ...
                signomenos.setImageResource(R.drawable.adicion);
            }else if (numAleatorio_uno >=4 && numAleatorio_uno <= 7){
                resultado = numAleatorio_uno - numAleatorio_dos;
                signomenos.setImageResource(R.drawable.resta);
            }else{
                resultado = numAleatorio_uno * numAleatorio_dos;
                signomenos.setImageResource(R.drawable.multiplicacion);
            }
            ...
            Toast.makeText(this, R.string.gano,Toast.LENGTH_LONG).show();
